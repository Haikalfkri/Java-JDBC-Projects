...
public class Main {
    ...
    private static void reserveRoom(Connection connection, Scanner scanner) {
        try {
            System.out.print("Enter guess name: ");
    ...
    private static boolean reservationExists(Connection connection, int reservatoinId) {
        try {
            String sql = "SELECT reservation_id FROM reservations WHERE reservation_id = " + reservatoinId;

            try (Statement statement = connection.createStatement();
                ResultSet resultSet = statement.executeQuery(sql)) {

                return resultSet.next(); // if there's a result
            }
        } catch (SQLException e) {
            e.printStackTrace();
            return false;
